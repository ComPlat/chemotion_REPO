  ...
  class ChemscannerAPI < Grape::API
    ...
    resource :chemscanner do
      ...
      post 'reagent_smiles' do
        ...
        serialized_molecules = reagents.map { |m|
    ...
    resource :chemscanner_storage do
      ...
      post 'all' do
        ...
        version = Chemscanner::Process::CHEMSCANNER_VERSION if version.nil?

        files = Chemscanner::Source.for_user(current_user.id).order(created_at: :desc)
        schemes = Chemscanner::Scheme.where(created_by: current_user.id, version: version)
        ...
        serialize_storage_outputs(files, schemes, reactions, molecules)
      end
        ...
        post do
          ...
          if type == 'Scheme'
            ...
            items.each do |item|
              ...
              item_schemes = item.children.reduce([]) { |arr, child|
      ...
      resource 'approve' do
        ...
        post do
          ...
          items.select! do |item| item.created_by == current_user.id end
          return {} if items.empty?
