...
const RepoCardStaticsBoard1 = (params) => {
  ...
  if (publishedStatics && publishedStatics.length !== 0) {
    ...
    const pubPage = { sample: `publications=${RepoNavListTypes.SAMPLE}`, reaction: `publications=${RepoNavListTypes.REACTION}` };
    return (
...
export default RepoCardStaticsBoard1;
