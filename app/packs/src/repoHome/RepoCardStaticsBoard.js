...
const RepoCardStaticsBoard = (params) => {
  ...
  if (publishedStatics && publishedStatics.length !== 0) {
    ...
    const stsAnalysisCnt = (stsAnalysisSort.length > 3) ? stsAnalysisSort
      .map(e => Number(e.e_cnt)).reduce((accumulator, currentValue) => accumulator + currentValue) : null
        ...
        <Col lg={12} md={12} sm={12} className="panel panel-info elem-info">
          ...
          <Col lg={12} md={12} sm={12} className="panel-heading dtl">
            <Row className="rr">
              ...
              {stsSampleReview && <div className="italic-desc">{stsSampleReview.e_cnt} under review</div>}
              {stsSampleEmbargo && <div className="italic-desc">{stsSampleEmbargo.e_cnt} under embargo</div>}
            </Row>
          </Col>
        </Col>
        <Col lg={12} md={12} sm={12} className="panel panel-info elem-info">
          ...
          <Col lg={12} md={12} sm={12} className="panel-heading dtl">
            <Row className="rr">
              ...
              {stsReactionReview && <div className="italic-desc">{stsReactionReview.e_cnt} under review</div>}
              {stsReactionEmbargo && <div className="italic-desc">{stsReactionEmbargo.e_cnt} under embargo</div>}
            </Row>
          </Col>
        </Col>
        {
          (stsAnalysisSort.length > 3) &&
          <Col lg={12} md={12} sm={12} className="panel panel-info elem-info">
            <Col lg={12} md={12} sm={12} className="panel-heading dtl">
              <Row className="rl">
